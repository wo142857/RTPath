...
local common   = require('resty.fastdfs.common')
local tcp = ngx.socket.tcp
local setmetatable = setmetatable
local error = error
local strip_string = common.strip_string
local fix_string   = common.fix_string
local buf2int      = common.buf2int
local int2buf      = common.int2buf
local read_int     = common.read_int
local read_fdfs_header = common.read_fdfs_header
local string = string
local table  = table
local date = os.date
...
function query_storage_update1(self, fileid)
    local group_name, file_name, err = common.split_fileid(fileid)
