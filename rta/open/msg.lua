local msg = {
    ...
    -->  mp3 to voic 
    MSG_ERROR_MP32VOICE                                   ={"ME01026","%s"},
    
    -->club
    MSG_ERROR_PARSE_DATA				={"ME01027", "parse data error"},
    MSG_DO_LUAKV_FAILED					={"ME01028", "luakv failed"},
    MSG_ERROR_COLLECT					={"ME01029", "collect error"},
    MSG_ERROR_GRID					={"ME01030", "grid error"},
    MSG_ERROR_IN_GRID					={"ME01031", "not in grid"},
    MSG_ERROR_TIME   					={"ME01032", "no over one hour"},			
 
    -->传入文件类型错误
    MSG_ERROR_FILE_TYPE				={"ME24600","must be mp4 file!"},
    MSG_ERROR_IMAGE_TYPE				={"ME24601","image format error!"},
    MSG_ERROR_VOICE_TYPE				={"ME24602","voice format error!"},
    -->sava file to dfs
